    ...
    <div>
      ...
      <Card>
        <Card.Body className="about-body">
          ...
          Coding Bootcamp. Proficient with front-end technologies HTML, CSS, JavaScript and React, and skilled in back-end technologies such as Node, SQL, mongoDB,
          graphql, and Sequelize. During my time at University of Denvers’s Coding Bootcamp. I have had the opportunity to work on over 20 projects ranging from simple 
