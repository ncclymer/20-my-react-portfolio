    ...
    <div>
      ...
      <Card>
        <Card.Body className="about-body">
          ...
          front-end web design to full stack applications. I am a strong independent worker and gladly welcome team collaboration. My goal is to provide an optimal
